...
adata_raw.write_h5ad("./dlpfc_preprocessed_151673.h5ad", compression="gzip")
...
np.savez("./dlpfc_matrices_151673.npz", X=gene_log, S=spatial_matrix, Y=labels)
